...
## การแจ้งเตือนผ่าน Telegram (v2.2+) 📱

ระบบสามารถส่งรายงานประจำวันตอนเที่ยงคืน (จำนวนความจำที่สลาย, ถูกเก็บเข้า Archive และข้อเท็จจริงใหม่) รวมถึงการรัน Backup กลับเข้ามือถือคุณได้

ติดตั้งง่ายๆ ตอนรัน `install.sh` หรือสร้างไฟล์ `~/.openclaw/v2/memory/.env` แล้วใส่ตัวแปรดังนี้:
```env
TELEGRAM_BOT_TOKEN=123456789:ABCDefghIJK_...
TELEGRAM_CHAT_ID=987654321
```

จากนั้นสามารถทดสอบการส่งข้อความได้ด้วย:
```bash
